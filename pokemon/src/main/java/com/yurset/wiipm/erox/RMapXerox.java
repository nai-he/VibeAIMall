...
public class RMapXerox extends RMapBase {
	...
	public RMapXerox(Context context, boolean iniFlag, int nodeY, int nodeX) {
		super(context);
		VData.relySize(32, 32);
		switch (nodeX) {
			case 0:
				logicMap = EMapsBase0.getMaps(nodeY);
				break;
			case 1:
				logicMap = EMapsBase1.getMaps(nodeY);
				break;
			case 2:
				logicMap = EMapsBase2.getMaps(nodeY);
				break;
			case 3:
				logicMap = EMapsBase3.getMaps(nodeY);
				break;
			case 4:
				logicMap = EMapsBase4.getMaps(nodeY);
				break;
			case 5:
				logicMap = EMapsBase5.getMaps(nodeY);
				break;
			case 6:
				logicMap = EMapsBase6.getMaps(nodeY);
				break;
			case 7:
				logicMap = EMapsBase7.getMaps(nodeY);
				break;
			case 8:
				logicMap = EMapsBase8.getMaps(nodeY);
				break;
			case 9:
				logicMap = EMapsBase9.getMaps(nodeY);
				break;
			case 10:
				logicMap = EMapsBaseA.getMaps(nodeY);
				break;
			case 11:
				logicMap = EMapsBaseB.getMaps(nodeY);
				break;
			case 12:
				logicMap = EMapsBaseC.getMaps(nodeY);
				break;
			case 13:
				logicMap = EMapsBaseD.getMaps(nodeY);
				break;
			case 14:
				logicMap = EMapsBaseE.getMaps(nodeY);
				break;
			case 15:
				logicMap = EMapsBaseF.getMaps(nodeY);
				break;
		}

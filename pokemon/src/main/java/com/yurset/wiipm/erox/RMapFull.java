...
public class RMapFull extends RMapBase {
	...
	public RMapFull(Context context, boolean iniFlag, int node) {
		super(context);
		VData.relySize(32, 32);
		switch (node) {
			case 0:
				logicMap = FMakeBaseFN.siteFull00;
				break;
			case 1:
				logicMap = FMakeBaseFN.siteFull01;
				break;
			case 2:
				logicMap = FMakeBaseFN.siteFull02;
				break;
			case 3:
				logicMap = FMakeBaseFN.siteFull03;
				break;
			case 4:
				logicMap = FMakeBaseFN.siteFull04;
				break;
			case 5:
				logicMap = FMakeBaseFN.siteFull05;
				break;
			case 6:
				logicMap = FMakeBaseFN.siteFull06;
				break;
			case 7:
				logicMap = FMakeBaseFN.siteFull07;
				break;
			case 8:
				logicMap = FMakeBaseFN.siteFull08;
				break;
			case 9:
				logicMap = FMakeBaseFN.siteFull09;
				break;
		}

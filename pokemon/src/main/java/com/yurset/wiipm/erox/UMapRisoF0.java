...
public class UMapRisoF0 extends RMapBase {
	...
	public UMapRisoF0(Context context, boolean iniFlag) {
		super(context);
		VData.relySize(14, 19);
		logicMap = FNodeBase.risof0;
		...
		spriteOdd10 = new Bitmap[180];
		sprite10 = FPublic.CreateBitmap(context, R.drawable.roomf00,
				15 * VData.UNIT, 12 * VData.UNIT);
		for (int i = 0; i < 12; i++) {
			for (int j = 0; j < 15; j++) {
